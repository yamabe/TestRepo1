                ...
                <EditItemTemplate>
                    <table>
                        <tr>
                            <td>
                                <table>
<y:YTextBox   id="材料ID"  Label="材料ID"   IsGrid="false" ReadOnly="TRUE" ValidationGroup="DetailUpdate" Text='<%# Bind("材料ID", "") %>'     IsRequired="true" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="70"/>
<y:YTextBox   id="材料名称"  Label="材料名称"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("材料名称", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="100"/>
<y:YDropDownList   id="材質大分類"  Label="材質大分類"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" SelectedValue='<%# Bind("材質大分類") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質大分類DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100"/>
<y:YDropDownList   id="材質"  Label="材質"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" SelectedValue='<%# Bind("材質") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100"/>
<y:YTextBox   id="定尺寸法縦"  Label="定尺寸法縦"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("定尺寸法縦", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺寸法横"  Label="定尺寸法横"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("定尺寸法横", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="厚み"  Label="厚み"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("厚み", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺仕入金額"  Label="定尺仕入金額"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("定尺仕入金額", "{0:f2}") %>'     IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺売り金額"  Label="定尺売り金額"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("定尺売り金額", "{0:f2}") %>'     IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YCheckBox   id="削除フラグ"  Label="削除フラグ"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Checked='<%# ConvertToBoolean(Eval("削除フラグ")) %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="65"/>
                ...
                <InsertItemTemplate>
                    <table>
                        <tr>
                            <td>
                                <table>
<y:YTextBox   id="材料ID" DefaultValue=""  Label="材料ID"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("材料ID", "") %>'     IsRequired="true" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="70" />
<y:YTextBox   id="材料名称" DefaultValue=""  Label="材料名称"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("材料名称", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="100" />
<y:YDropDownList   id="材質大分類" DefaultValue=""  Label="材質大分類"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" SelectedValue='<%# Bind("材質大分類") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質大分類DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100" />
<y:YDropDownList   id="材質" DefaultValue=""  Label="材質"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" SelectedValue='<%# Bind("材質") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100" />
<y:YTextBox   id="定尺寸法縦" DefaultValue=""  Label="定尺寸法縦"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("定尺寸法縦", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65" />
<y:YTextBox   id="定尺寸法横" DefaultValue=""  Label="定尺寸法横"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("定尺寸法横", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65" />
<y:YTextBox   id="厚み" DefaultValue=""  Label="厚み"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("厚み", "") %>'     IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65" />
<y:YTextBox   id="定尺仕入金額" DefaultValue=""  Label="定尺仕入金額"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("定尺仕入金額", "{0:f2}") %>'     IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65" />
<y:YTextBox   id="定尺売り金額" DefaultValue=""  Label="定尺売り金額"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("定尺売り金額", "{0:f2}") %>'     IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65" />
<y:YCheckBox   id="削除フラグ" DefaultValue=""  Label="削除フラグ"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Checked='<%# ConvertToBoolean(Eval("削除フラグ")) %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="65" />
                ...
                <ItemTemplate>
                    <table>
                        <tr>
                            <td>
                                <table>
<y:YTextBox   id="材料ID"  Label="材料ID"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("材料ID", "") %>'    IsRequired="true" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="70"/>
<y:YTextBox   id="材料名称"  Label="材料名称"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("材料名称", "") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="100"/>
<y:YDropDownList   id="材質大分類"  Label="材質大分類"  IsGrid="false"  ReadOnly="TRUE" SelectedValue='<%# Bind("材質大分類") %>'   IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質大分類DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100"/>
<y:YDropDownList   id="材質"  Label="材質"  IsGrid="false"  ReadOnly="TRUE" SelectedValue='<%# Bind("材質") %>'   IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""  DataSourceID="材質DataSource" DataTextField="名称" DataValueField="コードID"   AppendDataBoundItems="true"   Width="100"/>
<y:YTextBox   id="定尺寸法縦"  Label="定尺寸法縦"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("定尺寸法縦", "") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺寸法横"  Label="定尺寸法横"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("定尺寸法横", "") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="厚み"  Label="厚み"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("厚み", "") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺仕入金額"  Label="定尺仕入金額"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("定尺仕入金額", "{0:f2}") %>'    IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YTextBox   id="定尺売り金額"  Label="定尺売り金額"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("定尺売り金額", "{0:f2}") %>'    IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass=""   Width="65"/>
<y:YCheckBox   id="削除フラグ"  Label="削除フラグ"  IsGrid="false"  ReadOnly="TRUE" Checked='<%# ConvertToBoolean(Eval("削除フラグ")) %>'   IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass=""   Width="65"/>
