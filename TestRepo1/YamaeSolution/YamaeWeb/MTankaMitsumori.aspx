...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            定尺仕入金額_original.change(function () {
...
<asp:Content ID="Content5" ContentPlaceHolderID="Main" runat="Server">
    ...
    <y:YDropDownList   id="検索担当者" DefaultValue=""  Label="担当者"  IsGrid="false"    ValidationGroup="Search"    runat="server" DataSourceID="ユーザーDataSource" DataTextField="ユーザー名" DataValueField="ユーザーId" AppendDataBoundItems="true" AddEmptyItem="true" />
    ...
    <y:YDropDownList ID="順序" Width="160" runat="server" Label="順序" AutoPostBack="false">
        <asp:ListItem Value="見積日 desc,部品コード" Text="見積順" Selected="True"></asp:ListItem>
 ...
 <y:YBoundField HeaderText="見積日" DataFormatStringEditing="{0:yyyy/MM/dd}" DataField="見積日" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="100"  ItemStyle-Width="100"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="true"  DataFormatString="{0:yyyy/MM/dd}" IsInteger="false" runat="server" CssClass="Input"   />
 ...
 <y:YBoundField HeaderText="材料ID" DataFormatStringEditing="" DataField="材料ID" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="100"  ItemStyle-Width="100"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input"  DataSourceID="材料DataSource" DataTextField="材料名称識別テキスト" DataValueField="材料ID"  IsDropDownList="true"  />
 ...
 <y:YBoundField HeaderText="定尺寸法縦_original" DataFormatStringEditing="{0:f2}" DataField="定尺寸法縦_original" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺寸法横_original" DataFormatStringEditing="{0:f2}" DataField="定尺寸法横_original" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺仕入金額_original" DataFormatStringEditing="{0:f2}" DataField="定尺仕入金額_original" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="厚み" DataFormatStringEditing="{0:f2}" DataField="厚み" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"   />
 ...
 <y:YBoundField HeaderText="定尺仕入自動計算フラグ" DataFormatStringEditing="" DataField="定尺仕入自動計算フラグ" ReadOnly="FALSE"  IsBoolean="TRUE"  ControlStyle-Width="40"  ItemStyle-Width="40"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass="Input"  Visible="false" />

 <y:YBoundField HeaderText="定尺売り金額" DataFormatStringEditing="{0:f2}" DataField="定尺売り金額" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="時間単価" DataFormatStringEditing="{0:f2}" DataField="時間単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="分単価" DataFormatStringEditing="{0:f2}" DataField="分単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="秒単価" DataFormatStringEditing="{0:f2}" DataField="秒単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="m2あたりの材料費" DataFormatStringEditing="{0:f2}" DataField="m2あたりの材料費" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="m2あたりの取数たて" DataFormatStringEditing="{0:f2}" DataField="m2あたりの取数たて" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="m2あたりの取数よこ" DataFormatStringEditing="{0:f2}" DataField="m2あたりの取数よこ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="m2あたりの取数" DataFormatStringEditing="{0:f2}" DataField="m2あたりの取数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="仕入れ単価" DataFormatStringEditing="{0:f2}" DataField="仕入れ単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="たてしろ" DataFormatStringEditing="{0:f2}" DataField="たてしろ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="よこしろ" DataFormatStringEditing="{0:f2}" DataField="よこしろ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="見積_裁断" DataFormatStringEditing="{0:f2}" DataField="見積_裁断" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_打抜" DataFormatStringEditing="{0:f2}" DataField="見積_打抜" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_貼り" DataFormatStringEditing="{0:f2}" DataField="見積_貼り" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_曲げ" DataFormatStringEditing="{0:f2}" DataField="見積_曲げ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_仕上げ" DataFormatStringEditing="{0:f2}" DataField="見積_仕上げ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_ロス管理" DataFormatStringEditing="{0:f2}" DataField="見積_ロス管理" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_材料費比" DataFormatStringEditing="{0:f2}" DataField="見積_材料費比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="見積_加工費比" DataFormatStringEditing="{0:f2}" DataField="見積_加工費比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="見積_m2あたり材料費" DataFormatStringEditing="{0:f2}" DataField="見積_m2あたり材料費" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="true" />

 <y:YBoundField HeaderText="たて_しろあり" DataFormatStringEditing="{0:f2}" DataField="たて_しろあり" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="よこ_しろあり" DataFormatStringEditing="{0:f2}" DataField="よこ_しろあり" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="縦取り数" DataFormatStringEditing="{0:f2}" DataField="縦取り数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="横取り数" DataFormatStringEditing="{0:f2}" DataField="横取り数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="たて余" DataFormatStringEditing="{0:f2}" DataField="たて余" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="よこ余" DataFormatStringEditing="{0:f2}" DataField="よこ余" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="計算_取り数" DataFormatStringEditing="{0:f2}" DataField="計算_取り数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_材料費T" DataFormatStringEditing="{0:f2}" DataField="計算_材料費T" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_材料費" DataFormatStringEditing="{0:f2}" DataField="計算_材料費" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="計算_裁断" DataFormatStringEditing="{0:f2}" DataField="計算_裁断" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_打抜" DataFormatStringEditing="{0:f2}" DataField="計算_打抜" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_貼り" DataFormatStringEditing="{0:f2}" DataField="計算_貼り" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_曲げ" DataFormatStringEditing="{0:f2}" DataField="計算_曲げ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_仕上げ" DataFormatStringEditing="{0:f2}" DataField="計算_仕上げ" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_ロス管理" DataFormatStringEditing="{0:f2}" DataField="計算_ロス管理" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_材料費比" DataFormatStringEditing="{0:f2}" DataField="計算_材料費比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_加工費小計" DataFormatStringEditing="{0:f2}" DataField="計算_加工費小計" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_加工費比" DataFormatStringEditing="{0:f2}" DataField="計算_加工費比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_単価" DataFormatStringEditing="{0:f2}" DataField="計算_単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="定尺裁断_数" DataFormatStringEditing="" DataField="定尺裁断_数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺裁断_所要時間" DataFormatStringEditing="" DataField="定尺裁断_所要時間" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺裁断_割数" DataFormatStringEditing="" DataField="定尺裁断_割数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="寸法カット_数" DataFormatStringEditing="" DataField="寸法カット_数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="寸法カット_所要時間" DataFormatStringEditing="" DataField="寸法カット_所要時間" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="寸法カット_割数" DataFormatStringEditing="" DataField="寸法カット_割数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="打抜_型取数" DataFormatStringEditing="" DataField="打抜_型取数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="打抜_プレス回数" DataFormatStringEditing="" DataField="打抜_プレス回数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="曲げ_数" DataFormatStringEditing="" DataField="曲げ_数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="曲げ_秒数" DataFormatStringEditing="" DataField="曲げ_秒数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="曲げ_同時加工" DataFormatStringEditing="" DataField="曲げ_同時加工" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="仕上げ_数" DataFormatStringEditing="" DataField="仕上げ_数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="仕上げ_秒数" DataFormatStringEditing="" DataField="仕上げ_秒数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="仕上げ_同時加工" DataFormatStringEditing="" DataField="仕上げ_同時加工" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="ロス管理_材比" DataFormatStringEditing="{0:f2}" DataField="ロス管理_材比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="ロス管理_加工比" DataFormatStringEditing="{0:f2}" DataField="ロス管理_加工比" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />

 <y:YBoundField HeaderText="定尺裁断_時間" DataFormatStringEditing="{0:f2}" DataField="定尺裁断_時間" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺裁断_作業費" DataFormatStringEditing="{0:f2}" DataField="定尺裁断_作業費" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="定尺裁断_単価当り" DataFormatStringEditing="{0:f2}" DataField="定尺裁断_単価当り" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="寸法カット_時間" DataFormatStringEditing="" DataField="寸法カット_時間" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="寸法カット_作業費" DataFormatStringEditing="{0:f2}" DataField="寸法カット_作業費" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="寸法カット_単価当り" DataFormatStringEditing="{0:f2}" DataField="寸法カット_単価当り" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="打抜_時間当たりの加工数" DataFormatStringEditing="" DataField="打抜_時間当たりの加工数" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="打抜_単価当り" DataFormatStringEditing="{0:f2}" DataField="打抜_単価当り" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="曲げ_時間" DataFormatStringEditing="" DataField="曲げ_時間" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="曲げ_作業費" DataFormatStringEditing="{0:f2}" DataField="曲げ_作業費" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="曲げ_単価当り" DataFormatStringEditing="{0:f2}" DataField="曲げ_単価当り" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="仕上げ_時間" DataFormatStringEditing="" DataField="仕上げ_時間" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="仕上げ_作業費" DataFormatStringEditing="{0:f2}" DataField="仕上げ_作業費" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="仕上げ_単価当り" DataFormatStringEditing="{0:f2}" DataField="仕上げ_単価当り" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="ロス管理_材_費用" DataFormatStringEditing="{0:f2}" DataField="ロス管理_材_費用" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="ロス管理_加工_費用" DataFormatStringEditing="{0:f2}" DataField="ロス管理_加工_費用" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="見積_定尺裁断費比" DataFormatStringEditing="{0:f2}" DataField="見積_定尺裁断費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_定尺裁断費比" DataFormatStringEditing="{0:f2}" DataField="計算_定尺裁断費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_寸法カット費比" DataFormatStringEditing="{0:f2}" DataField="計算_寸法カット費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="見積_打抜費比" DataFormatStringEditing="{0:f2}" DataField="見積_打抜費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_打抜費比" DataFormatStringEditing="{0:f2}" DataField="計算_打抜費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_貼り費比" DataFormatStringEditing="{0:f2}" DataField="見積_貼り費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_貼り費比" DataFormatStringEditing="{0:f2}" DataField="計算_貼り費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_曲げ費比" DataFormatStringEditing="{0:f2}" DataField="見積_曲げ費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_曲げ費比" DataFormatStringEditing="{0:f2}" DataField="計算_曲げ費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_仕上げ費比" DataFormatStringEditing="{0:f2}" DataField="見積_仕上げ費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_仕上げ費比" DataFormatStringEditing="{0:f2}" DataField="計算_仕上げ費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="見積_ロス管理費比" DataFormatStringEditing="{0:f2}" DataField="見積_ロス管理費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />
 <y:YBoundField HeaderText="計算_ロス管理費比" DataFormatStringEditing="{0:f2}" DataField="計算_ロス管理費比" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"  Visible="false" />

 <y:YBoundField HeaderText="売単価" DataFormatStringEditing="{0:f2}" DataField="売単価" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Auto numeric"   />
 <y:YBoundField HeaderText="利益率" DataFormatStringEditing="{0:f2}" DataField="利益率" ReadOnly="TRUE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="FALSE" IsDate="false"  DataFormatString="{0:f2}" IsInteger="true" runat="server" CssClass="Auto numeric"   />
 <y:YBoundField HeaderText="ロット" DataFormatStringEditing="" DataField="ロット" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 <y:YBoundField HeaderText="丸め数" DataFormatStringEditing="" DataField="丸め数" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="65"  ItemStyle-Width="65"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input numeric"  Visible="false" />
 ...
 <y:YBoundField HeaderText="図面ファイル" DataFormatStringEditing="" DataField="図面ファイル" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="100"  ItemStyle-Width="100"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass="Input"  Visible="false" />
 <y:YBoundField HeaderText="備考" DataFormatStringEditing="" DataField="備考" ReadOnly="FALSE"  IsBoolean="FALSE"  ControlStyle-Width="100"  ItemStyle-Width="100"  ItemStyle-Wrap="false"      IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="false" runat="server" CssClass="Input"  Visible="false" />
...
<y:YTextBox   id="見積日"  Label="見積日"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" Text='<%# Bind("見積日", "{0:yyyy/MM/dd}") %>'     IsRequired="false" IsDate="true"  DataFormatString="{0:yyyy/MM/dd}" IsInteger="false" runat="server" CssClass="Input"   Width="100"/>
<y:YDropDownList   id="担当者"  Label="担当者"   IsGrid="false" ReadOnly="FALSE" ValidationGroup="DetailUpdate" SelectedValue='<%# Bind("担当者") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input"  DataSourceID="ユーザーDataSource" DataTextField="ユーザー名" DataValueField="ユーザーId"   AppendDataBoundItems="true"   Width="100"/>
...
<y:YTextBox   id="見積日" DefaultValue=""  Label="見積日"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" Text='<%# Bind("見積日", "{0:yyyy/MM/dd}") %>'     IsRequired="false" IsDate="true"  DataFormatString="{0:yyyy/MM/dd}" IsInteger="false" runat="server" CssClass="Input"   Width="100" />
<y:YDropDownList   id="担当者" DefaultValue=""  Label="担当者"  IsGrid="false"  ReadOnly="FALSE"  ValidationGroup="DetailInsert" SelectedValue='<%# Bind("担当者") %>'    IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input"  DataSourceID="ユーザーDataSource" DataTextField="ユーザー名" DataValueField="ユーザーId"   AppendDataBoundItems="true"   Width="100" />
                                        ...
                                        <y:YTextBox ID="定尺仕入金額_original" DefaultValue="" Label="定尺仕入金額【\】" IsGrid="false" ReadOnly="false" ValidationGroup="DetailInsert" Text='<%# Bind("定尺仕入金額_original", "{0:f2}") %>' IsRequired="FALSE" IsDate="false" DataFormatString="{0:c2}" IsInteger="true" runat="server" CssClass="Input" Width="65" />
                                        <tr>
                                            <td></td>
                                            <td>
                                                <asp:Button runat="server" ID="定尺情報設定" OnClick="定尺情報設定_Click" Text="定尺情報設定" /></td>
...
<y:YTextBox   id="見積日"  Label="見積日"  IsGrid="false"  ReadOnly="TRUE" Text='<%# Bind("見積日", "{0:yyyy/MM/dd}") %>'    IsRequired="false" IsDate="true"  DataFormatString="{0:yyyy/MM/dd}" IsInteger="false" runat="server" CssClass="Input"   Width="100"/>
<y:YDropDownList   id="担当者"  Label="担当者"  IsGrid="false"  ReadOnly="TRUE" SelectedValue='<%# Bind("担当者") %>'   IsRequired="false" IsDate="false"  DataFormatString="" IsInteger="true" runat="server" CssClass="Input"  DataSourceID="ユーザーDataSource" DataTextField="ユーザー名" DataValueField="ユーザーId"   AppendDataBoundItems="true"   Width="100"/>
...
<asp:formparameter  name="見積日" formfield="見積日"   ConvertEmptyStringToNull="true"  　Type="DateTime" />
<asp:formparameter  name="担当者" formfield="担当者"   ConvertEmptyStringToNull="true"  　Type="String" />
